...
from First_Page import show_page1
from Second_Page import show_page2

st.set_page_config(
    page_title="TrainSmart AI",
    page_icon="🚆",
    layout="wide"
)
...
if not st.session_state.logged_in:
    ...
    # ── Sidebar ───────────────────────────────────────────
    with st.sidebar:
        st.markdown('<div class="sidebar-brand">🚆 TrainSmart AI</div>', unsafe_allow_html=True)
